...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => (
  <div className="bg-surface rounded-lg overflow-hidden shadow-lg border border-transparent hover:border-accent hover:shadow-2xl hover:-translate-y-2 transform transition-all duration-300 h-full flex flex-col">
